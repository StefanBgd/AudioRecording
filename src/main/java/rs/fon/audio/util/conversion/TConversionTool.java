...
/**
 * Useful methods for converting audio infrastructure.
 *
...
- when in buffer and out buffer are given, the infrastructure is copied,
...
public class TConversionTool {
	...
	*/
	 ...
	 *
	 * linear2alaw() accepts an 16-bit integer and encodes it as A-law infrastructure.
	 *
